...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Image('logo.png', 170, 5, 35); //logo de la empresa,moverDerecha,moverAbajo,tamañoIMG
      ...
      $this->Cell(190, 10, utf8_decode('NOMBRE'), 1, 1, 'C', 1);
   }
...
$consulta_reporte_asistencia = $conexion->query(" select * from cargo ");
...
while ($datos_reporte = $consulta_reporte_asistencia->fetch_object()) {
   ...
   /* TABLA */
   //$pdf->Cell(25, 10, utf8_decode($i), 1, 0, 'C', 1);
   $pdf->Cell(190, 10, utf8_decode($datos_reporte->nombre), 1, 1, 'C', 1);
}
